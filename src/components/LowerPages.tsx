...
const commerceRows = [
  ...
  ["支払時期", "PersonalおよびTeamは申込時にクレジットカードを登録し、Subscription開始から5日間（120時間）の無料トライアル終了後に初回請求書を発行し、Stripeが決済を試みます。以後は1か月ごとの契約更新日に請求します。Enterpriseは個別契約に定めます。"],
  ["無料トライアル", "対象となるPersonalおよびTeamの初回申込者には、Subscription開始から5日間（120時間）の無料トライアルを提供します。期間中に解約した場合は初回課金を行いません。原則として1アカウントおよび1組織につき1回です。"],
